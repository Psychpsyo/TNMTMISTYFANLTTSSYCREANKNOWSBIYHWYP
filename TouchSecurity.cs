...
namespace TouchSecurity
{
    public class TouchSecurity : NeosMod
    {
        ...
        public override string Link => "https://github.com/Psychpsyo/TheNeosModThatMakesItSoThatYourFingersAreNoLongerTrustedTouchSourcesSoYouCanRestEasyAtNightKnowingNoOneWillShoveButtonsIntoYourHandWithoutYourPermission";

        public override void OnEngineInit() {
            Harmony harmony = new Harmony("Psychpsyo.TheNeosModThatMakesItSoThatYourFingersAreNoLongerTrustedTouchSourcesSoYouCanRestEasyAtNightKnowingNoOneWillShoveButtonsIntoYourHandWithoutYourPermission");
            harmony.PatchAll();
        }
